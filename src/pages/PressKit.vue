...
const markdown = computed(() => data.value?.pressKit?.body ?? '')
...
<template>
  <div class="p-8 space-y-6 text-gray-700 dark:text-gray-200">
    <div>
      <h1 class="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100">{{ t('pages.pressKit.title') }}</h1>
      <p class="text-gray-600 dark:text-gray-300">{{ t('pages.pressKit.summary') }}</p>
    </div>
